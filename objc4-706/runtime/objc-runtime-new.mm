...
static Class realizeClass(Class cls)
{
    ...
    if (strcmp(class_getName(cls), "NSObject") == 0) {
        printf("NSObject:%x, NSObject->isa:%x\n", cls, cls->ISA());
    }
    
    if (strcmp(class_getName(cls), "MyObject") == 0) {
        printf("MyObject:%x, MyOjbect->isa:%x\n", cls, cls->ISA());
    }
...
//        if (!strcmp(hi->fname(), "/Users/hecom/Library/Developer/Xcode/DerivedData/objc-cvusgpjldefswoadqnmkughhlrkn/Build/Products/Debug/debug_objc")) {
//            printf("modele:debug_objc");
//        }
//        printf("++++++++++module:%s++++++++++\n",hi->fname());
